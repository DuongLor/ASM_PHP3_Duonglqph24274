...
@section('title', 'Thêm Hình ảnh Phòng')
...
@endsection
@section('content')
    <form action="{{ route('imageRoom.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card mb-3">
            <div class="card-body">
                <div class="form-group pb-2 align-items-center">
                    <label class="mr-2 my-2"><i class="fas fa-Room"></i> Phòng</label>
